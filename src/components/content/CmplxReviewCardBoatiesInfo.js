...
import scc1 from '../../static/imgs/Australia-Day-7-1024x683.jpeg';
...
const CmplxReviewCardBoatiesInfo = () => {
        ...
        <Fade timeout={500} in={true}>
          <Card sx={{ maxWidth: 550 }}>
            <CardHeader
              ...
              title='South Curl Curl Boaties 2023/2024'
...
export default CmplxReviewCardBoatiesInfo;
