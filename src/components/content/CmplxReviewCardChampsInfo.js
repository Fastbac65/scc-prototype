...
import scc1 from '../../static/imgs/champs.jpeg';
...
const CmplxReviewCardChampsInfo = () => {
        ...
        <Fade timeout={500} in={true}>
          <Card sx={{ maxWidth: 550 }}>
            <CardHeader
              ...
              title='South Curl Curl Championship Life Savers 2023/2024'
...
export default CmplxReviewCardChampsInfo;
