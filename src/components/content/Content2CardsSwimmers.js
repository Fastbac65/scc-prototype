...
import CmplxReviewCardSwimmersInfo from './CmplxReviewCardSwimmersInfo';

const Content2CardsSwimmers = () => {
      ...
      <Grid container spacing={0}>
        ...
        >
          <Typography variant='h5' pt={1} m={2}>
            Welcome to South Curl Curl Swimming Club
          </Typography>
...
export default Content2CardsSwimmers;
